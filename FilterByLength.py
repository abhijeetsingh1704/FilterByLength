...
parser.add_argument("-l", "--length_min", dest='length_min', required=True, type=int, help='minimum lenght of sequence to retain')
parser.add_argument("-m", "--length_max", dest='length_max', required=False, type=int, help='max lenght of sequence to retain')
